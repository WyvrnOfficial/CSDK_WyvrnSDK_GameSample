...
#ifdef _WIN64
#define WYVRN_SDK_DLL	L"WyvrnSDK64.dll"
#else
#define WYVRN_SDK_DLL	L"WyvrnSDK.dll"
#endif
...
int WyvrnAPI::InitAPI()
{
	...
	{
		WyvrnLogger::fprintf(stderr, "Detected old version of Wyvrn SDK Library!\r\n");
	...
	if (_sInvalidSignature)
	{
		WyvrnLogger::fprintf(stderr, "Wyvrn SDK Library has an invalid signature!\r\n");
		return RZRESULT_DLL_INVALID_SIGNATURE;
	}
	...
	if (library == NULL)
	{ 
		WyvrnLogger::fprintf(stderr, "Failed to load Wyvrn SDK Library!\r\n");
        return RZRESULT_DLL_NOT_FOUND;
	}
...
bool WyvrnAPI::IsInitializedAPI()
{
